...
<div class="nooverflow">
    ...
    <div class="titlecontainer">
        <h1 v-if="!isMobile" class="mt-6 font-roboto text-bold">FTC 1002</h1>

        <div class="flex flex-row justify-around w-screen my-6">
            <div class="w-96">
                <h2 class="text-2xl text-bold text-center mb-2">About FTC 1002</h2>
                <p class="text-xl">
            ...
            <div class="flex flex-col justify-around">
                <div class="w-[400px]">
                    ...
                    <p class="text-center ">FTC 1002 finished 42nd of 80 in their Jemison divison at the World Championship in Houston, Texas. Nice job!</p>
