          ...
          <div class="grid grid-rows-3 gap-8">
              ...
              <div class="basis-2/3">
                <div class="containerwrap px-4">
                  <div class="flex flex-row py-4">
                    ...
                    <q-btn label="To Site" color="orange" @click="goto(`https://www.firstinspires.org/robotics/ftc`)"/>                  
                  </div>
                  <p class="font-franklin">
            ...
            <div class="containerwrap">
              ...
              <div class="basis-2/3">
                <div class="containerwrap px-2">
                  <div class="flex flex-row pb-4">
                    <h2 class="text-3xl text-bold pr-8">BEST</h2>  
                    <q-btn label="To Site" color="green" @click="goto(`https://www.bestrobotics.org/site/`)"/>                  
                  </div>
                  <p class="font-franklin">
                    BEST, a middle and high school robotics competition whose mission is to engage and excite students about engineering, science, and technology as well as inspire them to pursue careers in these fields.
